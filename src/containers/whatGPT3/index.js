...
const WhatGPT3 = () => {
  return (
    <div className="gtp3_whatgtp3 section__margin" id="wgpt3">
    <div className="gtp3_whatgtp3-feature">
    ...
    <div className="gtp3_whatgtp3-heading">
      <h1 className="gradient__text">The possibilities are beyond your imagination</h1>
      <p>Explore the Library</p>
    </div>
    <div className="gtp3_whatgtp3-container">
